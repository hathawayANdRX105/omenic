...
use omenic_harness_jobs::LocalJobRegistry;
use omenic_harness_terminal::TerminalRegistry;
use omenic_harness_tools::jobs_terminal::{
...
fn session_tools_registrates_every_tool() {
    use omenic_harness_tools::jobs_terminal::{SESSION_TOOL_NAMES, session_tools};
