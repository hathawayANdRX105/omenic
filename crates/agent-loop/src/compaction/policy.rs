...
use protocol::chat::{Content, Message as ChatMessage};

use super::pairing::advance_to_balanced;
use super::region::{KEEP_RECENT_MIN, RegionBudget, recent_window_cut};
use super::summarize::{NoopSummarizer, Summarizer, render_transcript};
...
/// First index to keep verbatim: the [`super::region`] char-budget window
/// advanced to the nearest tool-pairing-balanced position
/// ([`super::pairing`]). `0` means the whole context fits the recent window
