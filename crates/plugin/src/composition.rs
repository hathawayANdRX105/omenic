...
use crate::plugins::CompactionPlugin;
use crate::plugins::GuardPlugin;
use crate::plugins::InstructionPlugin;
use crate::plugins::SkillPlugin;
use crate::{DshPlugin, Fiber, PluginError, PluginRegistry};
use agent_loop::LoopEngine;
use guard::GuardConfig;
use serde_json::Value;
use skill::PromptTemplate;
use std::sync::Arc;
use subagent::{SubagentRuntime, ToolSubagentControlPlugin, ToolSubagentPlugin};
...
pub fn assemble(
    ...
    let mut registry = PluginRegistry::default();
    {
        ...
        ctx.provide("harness.tools", tools::default_catalog());
        ...
        ctx.provide("orbit.max_turns", agent_loop::orbit::DEFAULT_MAX_TURNS);
        ctx.provide("orbit.backend", agent_loop::orbit::HttpLlm);
