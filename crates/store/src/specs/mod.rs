//! Template layer: spec table generation, parsing, rendering, and validation.
//!
//! Produces markdown skeletons for GitHub artifacts (issues, PRs, reviews)
//! and checks filled documents against template rules.
